...
/*   Updated: 2013/11/25 09:21:03 by pgallois         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				uf_test_strlcat(void)
{
	...
	{
	/*	ft_putstr(dest2);
		ft_putnbr(ft_strlcat(dest, "Hello ", 4));
		ft_putchar('\n');
		ft_putstr(dest);
		ft_putnbr(strlcat(dest, "Hello ", 4));
		ft_putchar('\n');
		ft_putnbr(ft_strlcat(dest, "Hello ", 8));
		ft_putchar('\n');
		ft_putnbr(strlcat(dest, "Hello ", 8));*/
	D_ERROR
	}
	...
	{
		ft_putstr(dest2);
/*		ft_putnbr(ft_strlcat(dest2, "abc", 6));*/
		ft_putchar('\n');
		ft_putstr(dest);
/*		ft_putnbr(strlcat(dest, "abc", 6));*/
		ft_putchar('\n');
        D_ERROR
	}
	return (1);
